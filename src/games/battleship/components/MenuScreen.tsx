...
import { FLEET_COUNT, GAME_MODES } from "@/games/battleship/constants/board";
...
const MODE_ICON: Record<GameMode, string> = { classic: "⚓", moving: "🧭" };
...
export function MenuScreen() {
  ...
  const start = async () => {
    ...
    useGameStore.getState().startLocal(mode, playerName);
    router.push('/battleship/game');
  };
    ...
    >
      ...
      >
        ...
        <Pressable onPress={onLogoTap} hitSlop={8} accessibilityLabel={t("app_title")}>
          <Image
            source={require("../../../../assets/games/battleship/logo.png")}
        ...
        <View style={styles.modeRow}>
          {GAME_MODES.map((value) => {
            ...
            return (
              ...
              >
                <Text style={styles.modeIcon}>{MODE_ICON[value]}</Text>
                <Text
                  numberOfLines={1}
                  style={[styles.modeName, { color: theme.textPrimary }]}
                >
                  {t(value === "classic" ? "mode_classic" : "mode_moving")}
                </Text>
        ...
        <Text style={[styles.modeHint, { color: theme.textSecondary }]}>
          {t(mode === "classic" ? "mode_classic_hint" : "mode_moving_hint")}
        </Text>

        <View style={[styles.countPill, { backgroundColor: theme.card }]}>
          <Text style={styles.countNumber}>{FLEET_COUNT}</Text>
        ...
        <View style={styles.actionRow}>
          ...
          <Pressable
            style={[styles.primaryButton, styles.rowButton]}
            onPress={() => router.push('/battleship/online')}
          >
            <Text
              style={styles.primaryButtonText}
              numberOfLines={1}
        ...
        <Pressable
          style={[styles.secondaryButton, styles.wideButton]}
          onPress={() => router.push('/battleship/rules')}
        >
        ...
        <View style={styles.settingsRow}>
          <Pressable
            ...
            onPress={() => router.push('/battleship/settings')}
          >
...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 210, height: 210, alignSelf: "center" },
